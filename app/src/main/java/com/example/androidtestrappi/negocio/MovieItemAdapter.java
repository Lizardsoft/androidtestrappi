...
public class MovieItemAdapter extends BaseAdapter implements Filterable {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint == null || constraint.length() == 0) {
                    ...
                    List<MovieItem> resultsData = new ArrayList<>();
                    String searchStr = constraint.toString().toUpperCase();
                    for (MovieItem o : items)
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                items = (List<MovieItem>) results.values;
    ...
    public MovieItemAdapter(Context context, List<MovieItem> items, int totalPages) {
