...
public class TvItemAdapter extends BaseAdapter implements Filterable {
    ...
    public void addItems(List<TvItem> items) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint == null || constraint.length() == 0) {
                    ...
                    List<TvItem> resultsData = new ArrayList<>();
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                items = (List<TvItem>) results.values;
    ...
    public TvItemAdapter(Context context, List<TvItem> items, int totalPages) {
